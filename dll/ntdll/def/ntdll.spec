...
@ stdcall -version=0x600+ NtOpenKeyTransacted(ptr long ptr ptr)
...
@ stub -stub -version=0x600+ ZwAcquireCMFViewOwnership
...
@ stdcall -version=0x600+ ZwCancelIoFileEx(long ptr ptr) NtCancelIoFileEx
...
@ stdcall -version=0x600+ ZwOpenKeyTransacted(ptr long ptr ptr)
