...
;Windows 7 stuff
@ stdcall -stub -version=0x600+ RtlAddIntegrityLabelToBoundaryDescriptor()

;Windows 8 stuff
@ stdcall -stub -version=0x602+ ApiSetQueryApiSetPresence()	
@ stdcall -stub -version=0x602+ EtwEventSetInformation()
@ stdcall -stub -version=0x602+ LdrAddDllDirectory()
@ stdcall -stub -version=0x602+ LdrGetDllDirectory()
@ stdcall -stub -version=0x602+ LdrGetDllFullName()
@ stdcall -stub -version=0x602+ LdrGetDllPath()
@ stdcall -stub -version=0x602+ LdrGetProcedureAddressForCaller()	
@ stdcall -stub -version=0x602+ LdrProcessRelocationBlockEx()
@ stdcall -stub -version=0x602+ LdrQueryOptionalDelayLoadedAPI()
@ stdcall -stub -version=0x602+ LdrRemoveDllDirectory()
@ stdcall -stub -version=0x602+ LdrResolveDelayLoadedAPI()
@ stdcall -stub -version=0x602+ LdrResolveDelayLoadsFromDll()
@ stdcall -stub -version=0x602+ LdrSetDefaultDllDirectories()
@ stdcall -stub -version=0x602+ LdrSetDllDirectory()
@ stdcall -stub -version=0x602+ LdrSetPackagedDllDirectoriesList()
@ stdcall -stub -version=0x602+ LdrSystemDllInitBlock()
@ stdcall -stub -version=0x602+ NtAddAtomEx()	
@ stdcall -stub -version=0x602+ NtAdjustTokenClaimsAndDeviceGroups()	
@ stdcall -stub -version=0x602+ NtAlertThreadByThreadId()
@ stdcall -stub -version=0x602+ NtAlpcConnectPortEx()
@ stdcall -stub -version=0x602+ NtAssociateWaitCompletionPacket()	
@ stdcall -stub -version=0x602+ NtCancelWaitCompletionPacket()	
@ stdcall -stub -version=0x602+ NtCreateDirectoryObjectEx()	
@ stdcall -stub -version=0x602+ NtCreateLowBoxToken()	
@ stdcall -stub -version=0x602+ NtCreateTokenEx()	
@ stdcall -stub -version=0x602+ NtCreateWaitCompletionPacket()	
@ stdcall -stub -version=0x602+ NtCreateWnfStateName()	
@ stdcall -stub -version=0x602+ NtDeleteWnfStateData()	
@ stdcall -stub -version=0x602+ NtDeleteWnfStateName()	
@ stdcall -stub -version=0x602+ NtFilterTokenEx()	
@ stdcall -stub -version=0x602+ NtFlushBuffersFileEx()	
@ stdcall -stub -version=0x602+ NtPrefetchVirtualMemory()	
@ stdcall -stub -version=0x602+ NtQueryWnfStateData()	
@ stdcall -stub -version=0x602+ NtQueryWnfStateNameInformation()	
@ stdcall -stub -version=0x602+ NtSetSystemCodeIntegrityRoots()	
@ stdcall -stub -version=0x602+ NtSubscribeWnfStateChange()	
@ stdcall -stub -version=0x602+ NtUnmapViewOfSectionEx()	
@ stdcall -stub -version=0x602+ NtUnsubscribeWnfStateChange()	
@ stdcall -stub -version=0x602+ NtUpdateWnfStateData()	
@ stdcall -stub -version=0x602+ NtWaitForAlertByThreadId()	
@ stdcall -stub -version=0x602+ NtWaitForWnfNotifications()	
@ stdcall -stub -version=0x602+ NtWow64AllocateVirtualMemory64()	
@ stdcall -stub -version=0x602+ RtlAddResourceAttributeAce()	
@ stdcall -stub -version=0x602+ RtlAddScopedPolicyIDAce()	
@ stdcall -stub -version=0x602+ RtlAllocateWnfSerializationGroup()	
@ stdcall -stub -version=0x602+ RtlCancelWnfMetaNotification()	
@ stdcall -stub -version=0x602+ RtlCheckPortableOperatingSystem()
@ stdcall -stub -version=0x602+ RtlCheckTokenCapability()	
@ stdcall -stub -version=0x602+ RtlCheckTokenMembership()	
@ stdcall -stub -version=0x602+ RtlCheckTokenMembershipEx()	
@ stdcall -stub -version=0x602+ RtlClearBit()	
@ stdcall -stub -version=0x602+ RtlCopyBitMap()	
@ stdcall -stub -version=0x602+ RtlCopyContext()	
@ stdcall -stub -version=0x602+ RtlDecompressBufferEx()	
@ stdcall -stub -version=0x602+ RtlDeleteElementGenericTableAvlEx()	
@ stdcall -stub -version=0x602+ RtlEqualWnfChangeStamps()	
@ stdcall -stub -version=0x602+ RtlExtractBitMap()	
@ stdcall -stub -version=0x602+ RtlGetAppContainerNamedObjectPath()	
@ stdcall -stub -version=0x602+ RtlGetExePath()	
@ stdcall -stub -version=0x602+ RtlGetSearchPath()	
@ stdcall -stub -version=0x602+ RtlGetSystemTimePrecise()
@ stdcall -stub -version=0x602+ RtlInsertElementGenericTableAvl2()	
@ stdcall -stub -version=0x602+ RtlIsCapabilitySid()	
@ stdcall -stub -version=0x602+ RtlIsPackageSid()	
@ stdcall -stub -version=0x602+ RtlLookupElementGenericTableAvl2()	
@ stdcall -stub -version=0x602+ RtlNumberOfClearBitsInRange()	
@ stdcall -stub -version=0x602+ RtlNumberOfSetBitsInRange()	
@ stdcall -stub -version=0x602+ RtlPublishWnfStateData()	
@ stdcall -stub -version=0x602+ RtlQueryValidationRunlevel()	
@ stdcall -stub -version=0x602+ RtlQueryWnfMetaNotification()	
@ stdcall -stub -version=0x602+ RtlQueryWnfStateData()	
@ stdcall -stub -version=0x602+ RtlQueryWnfStateDataWithExplicitScope()	
@ stdcall -stub -version=0x602+ RtlRbInsertNodeEx()	
@ stdcall -stub -version=0x602+ RtlRbRemoveNode()	
@ stdcall -stub -version=0x602+ RtlRegisterForWnfMetaNotification()	
@ stdcall -stub -version=0x602+ RtlReleasePath()	
@ stdcall -stub -version=0x602+ RtlSetBit()
@ stdcall -stub -version=0x602+ RtlSetPortableOperatingSystem()	
@ stdcall -stub -version=0x602+ RtlSetSearchPathMode()	
@ stdcall -stub -version=0x602+ RtlSubscribeWnfStateChangeNotification()	
@ stdcall -stub -version=0x602+ RtlTestAndPublishWnfStateData()	
@ stdcall -stub -version=0x602+ RtlTryConvertSRWLockSharedToExclusiveOrRelease()	
@ stdcall -stub -version=0x602+ RtlUnsubscribeWnfNotificationWaitForCompletion()	
@ stdcall -stub -version=0x602+ RtlUnsubscribeWnfNotificationWithCompletionCallback()	
@ stdcall -stub -version=0x602+ RtlUnsubscribeWnfStateChangeNotification()	
@ stdcall -stub -version=0x602+ RtlWaitForWnfMetaNotification()	
@ stdcall -stub -version=0x602+ RtlWaitOnAddress()
@ stdcall -stub -version=0x602+ RtlWakeAddressAll()	
@ stdcall -stub -version=0x602+ RtlWakeAddressSingle()	
@ stdcall -stub -version=0x602+ RtlWnfDllUnloadCallback()	
@ stdcall -stub -version=0x602+ RtlpConvertAbsoluteToRelativeSecurityAttribute()	
@ stdcall -stub -version=0x602+ RtlpConvertRelativeToAbsoluteSecurityAttribute()	
@ stdcall -stub -version=0x602+ RtlpMergeSecurityAttributeInformation()	
@ stdcall -stub -version=0x602+ RtlpWnfNotificationThread()
@ stdcall -stub -version=0x602+ TpAllocJobNotification()	
@ stdcall -stub -version=0x602+ TpCallbackDetectedUnrecoverableError()	
@ stdcall -stub -version=0x602+ TpReleaseJobNotification()	
@ stdcall -stub -version=0x602+ TpSetTimerEx()	
@ stdcall -stub -version=0x602+ TpSetWaitEx()	
@ stdcall -stub -version=0x602+ TpTimerOutstandingCallbackCount()
@ stdcall -stub -version=0x602+ TpWaitForJobNotification()
@ stdcall -stub -version=0x602+ ZwAddAtomEx()
@ stdcall -stub -version=0x602+ ZwAdjustTokenClaimsAndDeviceGroups()
@ stdcall -stub -version=0x602+ ZwAlertThreadByThreadId()
@ stdcall -stub -version=0x602+ ZwAlpcConnectPortEx()
@ stdcall -stub -version=0x602+ ZwAssociateWaitCompletionPacket()
@ stdcall -stub -version=0x602+ ZwCancelWaitCompletionPacket()
@ stdcall -stub -version=0x602+ ZwCreateDirectoryObjectEx()
@ stdcall -stub -version=0x602+ ZwCreateLowBoxToken()
@ stdcall -stub -version=0x602+ ZwCreateTokenEx()
@ stdcall -stub -version=0x602+ ZwCreateWaitCompletionPacket()
@ stdcall -stub -version=0x602+ ZwCreateWnfStateName()
@ stdcall -stub -version=0x602+ ZwDeleteWnfStateData()
@ stdcall -stub -version=0x602+ ZwDeleteWnfStateName()
@ stdcall -stub -version=0x602+ ZwFilterTokenEx()
@ stdcall -stub -version=0x602+ ZwFlushBuffersFileEx()
@ stdcall -stub -version=0x602+ ZwPrefetchVirtualMemory()
@ stdcall -stub -version=0x602+ ZwQueryWnfStateData()
@ stdcall -stub -version=0x602+ ZwQueryWnfStateNameInformation()
@ stdcall -stub -version=0x602+ ZwSetSystemCodeIntegrityRoots()
@ stdcall -stub -version=0x602+ ZwSubscribeWnfStateChange()
@ stdcall -stub -version=0x602+ ZwUnmapViewOfSectionEx()
@ stdcall -stub -version=0x602+ ZwUnsubscribeWnfStateChange()
@ stdcall -stub -version=0x602+ ZwUpdateWnfStateData()
@ stdcall -stub -version=0x602+ ZwWaitForAlertByThreadId()
@ stdcall -stub -version=0x602+ ZwWaitForWnfNotifications()
@ stdcall -stub -version=0x602+ ZwWow64AllocateVirtualMemory64()	
