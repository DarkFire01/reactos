...
@ stdcall -version=0x600 BaseFormatObjectAttributes(ptr ptr ptr)
@ stdcall -version=0x600 BasepAllocateActivationContextActivationBlock(long ptr ptr ptr)
@ stdcall -stub -version=0x600 BasepAnsiStringToDynamicUnicodeString(wstr str)
@ stdcall -version=0x600 BasepFreeActivationContextActivationBlock(ptr)
@ stdcall -version=0x600 BaseFormatTimeOut(ptr long)
@ stdcall -version=0x600 BaseGetNamedObjectDirectory()
@ stdcall -version=0x600 Basep8BitStringToDynamicUnicodeString(wstr str)
@ stdcall -version=0x600 BasepMapModuleHandle(ptr long)
@ stdcall -version=0x600 BaseSetLastNTError(long)
@ stdcall -stub -version=0x600 CreateRemoteThreadEx(long ptr long ptr long long ptr ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 CreateUmsCompletionList(ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 CreateUmsThreadContext(ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 DeleteUmsCompletionList(ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 DeleteUmsThreadContext(ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 DequeueUmsCompletionListItems(ptr long ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 EnterUmsSchedulingMode(ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 ExecuteUmsThread(ptr)
@ stdcall -stub -version=0x600 FindStringOrdinal(long wstr long wstr long long)
@ stdcall -stub -version=0x600 GetActiveProcessorCount(long)
@ stdcall -stub -version=0x600 GetActiveProcessorGroupCount()
@ stdcall -stub -version=0x600 GetCurrentProcessorNumberEx(ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 GetCurrentUmsThread()
@ stdcall -stub -version=0x600 -ret64 -arch=i386,x86_64 GetEnabledXStateFeatures()
@ stdcall -stub -version=0x600 GetMaximumProcessorCount(long)
@ stdcall -stub -version=0x600 GetMaximumProcessorGroupCount()
@ stdcall -stub -version=0x600 GetTimeFormatWWorker(long long ptr wstr ptr long)
;@ stdcall -stub -version=0x600 GetLogicalProcessorInformationEx(long ptr ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 GetNextUmsListItem(ptr)
@ stdcall -stub -version=0x600 GetNumaAvailableMemoryNodeEx(long ptr)
@ stdcall -stub -version=0x600 GetNumaNodeProcessorMaskEx(long ptr)
@ stdcall -stub -version=0x600 GetNumaProcessorNodeEx(ptr ptr)
@ stdcall -stub -version=0x600 GetNumaProximityNodeEx(long ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 GetUmsCompletionListEvent(ptr ptr)
@ stdcall -stub -version=0x600 K32EmptyWorkingSet(ptr)
@ stdcall -stub -version=0x600 K32GetMappedFileNameA(ptr ptr ptr long)
@ stdcall -stub -version=0x600 K32GetProcessImageFileNameA(ptr ptr long)
@ stdcall -stub -version=0x600 K32GetProcessImageFileNameW(ptr ptr long)
@ stdcall -stub -version=0x600 K32GetWsChanges(ptr ptr long)
@ stdcall -stub -version=0x600 K32GetWsChangesEx(ptr ptr ptr)
@ stdcall -stub -version=0x600 K32InitializeProcessForWsWatch(ptr)
@ stdcall -stub -version=0x600 LoadAppInitDlls()
@ stdcall -stub -version=0x600 PowerCreateRequestW(ptr)
@ stdcall -stub -version=0x600 QueryIdleProcessorCycleTimeEx(long ptr ptr)
@ stdcall -stub -version=0x600 QueryThreadpoolStackInformation(ptr ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 QueryUmsThreadInformation(ptr long ptr long ptr)
@ stdcall -stub -version=0x600 RaiseFailFastException(ptr ptr long)
@ stdcall -version=0x600 SetThreadIdealProcessorEx(ptr ptr ptr)
@ stdcall -stub -version=0x600 SetThreadpoolStackInformation(ptr ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 SetUmsThreadInformation(ptr long ptr long)
@ stdcall -stub -version=0x600 SetWaitableTimerEx(ptr ptr long ptr ptr ptr long)
@ stdcall -stub -version=0x600 -arch=i386,x86_64 SetXStateFeaturesMask(ptr int64)
@ stdcall -stub -version=0x600 SystemTimeToTzSpecificLocalTimeEx(ptr ptr ptr)
@ stdcall -stub -version=0x600 TzSpecificLocalTimeToSystemTimeEx(ptr ptr ptr)
@ stdcall -stub -version=0x600 WerRegisterRuntimeExceptionModule(wstr ptr)
@ stdcall -stub -version=0x600 WerUnregisterRuntimeExceptionModule(wstr ptr)
@ stdcall -stub -version=0x600 Wow64GetThreadSelectorEntry(ptr long ptr)
@ stdcall -stub -version=0x600 -arch=x86_64 UmsThreadYield(ptr)
@ stdcall -stub -version=0x600 -arch=i386,x86_64 InitializeContext(ptr long ptr ptr)
@ stub  -version=0x600+ GetProductName
@ stub  -version=0x600 GetXStateFeaturesMask
@ stub  -version=0x600 LoadStringByReference
@ stub  -version=0x600 LocateXStateFeature
@ stub  -version=0x600 GetEraNameCountedString
