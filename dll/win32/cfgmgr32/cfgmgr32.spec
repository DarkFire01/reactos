...
@ stdcall CM_Get_Class_PropertyW(ptr ptr ptr ptr ptr long) setupapi.CM_Get_Class_PropertyW
@ stdcall CM_Get_Class_Property_ExW(ptr ptr ptr ptr ptr long ptr) setupapi.CM_Get_Class_Property_ExW
...
@ stdcall CM_Get_DevNode_Property_Keys(long ptr ptr long) setupapi.CM_Get_DevNode_Property_Keys
@ stdcall CM_Get_DevNode_Property_Keys_Ex(long ptr ptr long ptr) setupapi.CM_Get_DevNode_Property_Keys_Ex
...
@ stdcall CM_Get_Device_Interface_Property_ExW(wstr ptr ptr ptr ptr long ptr) setupapi.CM_Get_Device_Interface_Property_ExW
@ stdcall CM_Get_Device_Interface_Property_KeysW(wstr ptr ptr long) setupapi.CM_Get_Device_Interface_Property_KeysW
@ stdcall CM_Get_Device_Interface_Property_Keys_ExW(wstr ptr ptr long ptr) setupapi.CM_Get_Device_Interface_Property_Keys_ExW
...
@ stdcall CM_Set_Class_PropertyW(ptr ptr long ptr long long) setupapi.CM_Set_Class_PropertyW
@ stdcall CM_Set_Class_Property_ExW(ptr ptr long ptr long long ptr) setupapi.CM_Set_Class_Property_ExW
...
@ stdcall CM_Set_DevNode_PropertyW(long ptr long ptr long long) setupapi.CM_Set_DevNode_PropertyW
@ stdcall CM_Set_DevNode_Property_ExW(long ptr long ptr long long ptr) setupapi.CM_Set_DevNode_Property_ExW
...
@ stdcall CM_Set_Device_Interface_PropertyW(wstr ptr long ptr long long) setupapi.CM_Set_Device_Interface_PropertyW
@ stdcall CM_Set_Device_Interface_Property_ExW(wstr ptr long ptr long long ptr) setupapi.CM_Set_Device_Interface_Property_ExW
