            ...
            foreach(_define ${_defines_semicolon_list})
                if(NOT ${_define} STREQUAL "NOTFOUND")
                    list(APPEND _source_file_defines -D${_define})
                            # Add architecture-specific defines for ASM preprocessor
                            if(ARCH STREQUAL "amd64")
                                list(APPEND _source_file_defines -D_M_AMD64 -D_AMD64_)
                            elseif(ARCH STREQUAL "arm64")
                                list(APPEND _source_file_defines -D_M_ARM64 -D_ARM64_)
                            elseif(ARCH STREQUAL "arm")
                                list(APPEND _source_file_defines -D_M_ARM -D_ARM_)
                            elseif(ARCH STREQUAL "i386")
                                list(APPEND _source_file_defines -D_M_IX86 -D_X86_)
                            endif()
                endif()
            endforeach()
            add_custom_command(
