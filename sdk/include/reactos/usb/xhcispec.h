...
typedef struct _XHCI_EVENT_TRANSFER_TRB
{
    ...
    struct
    {
        ULONG CompletionCode                : 23;
        ULONG TrbTransferLen                : 9;
    };
    struct
    {
        ULONG CycleBit                      : 1;
...
} XHCI_EVENT_TRANSFER_TRB, *PXHCI_EVENT_TRANSFER_TRB ;
...
{
    XHCI_STOP_ENDPOINT_COMMAND_TRB StopEndpoint;
