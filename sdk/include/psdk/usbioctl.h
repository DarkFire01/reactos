...
/*
 * How one hub port is physically wired, asked per companion port by index.
 * ActualLength reports the full size, so a short first call sizes the second.
 */
...
/*
 * The speed a port and its device are running at. The hub answers only within
 * the protocols the caller says it understands.
 */
