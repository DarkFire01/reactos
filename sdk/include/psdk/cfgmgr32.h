...
/*
 * Device notification, Windows 8 and later. Declared unconditionally
 * rather than behind a WINVER guard: the tree builds setupapi - which is
 * where these are implemented - at WINVER 0x502, so a guard would hide the
 * types from their own implementation. The spec entries gate the exports.
 */
