...
#define CBAUD   0x0000F000  // baud rate mask (ignored by the pty)
...
//
// Window size and terminal ioctls used by terminal emulators and the pty layer
//
...
#define TIOCSPTLCK  0x40045431  // lock or unlock pty slave (no-op)
