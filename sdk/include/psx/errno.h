 ...
 * PURPOSE:     POSIX error numbers (IEEE Std 1003.1-1990, s.2.5)
...
#define EUCLEAN      35 // (NT-specific) Unknown error
...
//
// The per-thread errno cell is published by PSXDLL at process startup
//
extern int errno;
