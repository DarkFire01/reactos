 ...
 * PURPOSE:     Receive side scaling capabilities and callbacks
 */
...
typedef EVT_NET_ADAPTER_RECEIVE_SCALING_SET_HASH_SECRET_KEY
    *PFN_NET_ADAPTER_RECEIVE_SCALING_SET_HASH_SECRET_KEY;
...
typedef EVT_NET_ADAPTER_RECEIVE_SCALING_SET_INDIRECTION_ENTRIES
    *PFN_NET_ADAPTER_RECEIVE_SCALING_SET_INDIRECTION_ENTRIES;
    ...
    _In_ const NET_ADAPTER_RECEIVE_SCALING_CAPABILITIES *Capabilities)
{
    ((PFN_NETADAPTERSETRECEIVESCALINGCAPABILITIES)
        NetFunctions[NetAdapterSetReceiveScalingCapabilitiesTableIndex])(
