...
/* Commands to the miniport are method OIDs, and its indications status codes, on the message id */
#define WDI_OID_PREFIX                      0xE4400000U
#define WDI_INDICATION_PREFIX               0x40050000U
#define WDI_DEFINE_OID(_MessageId)          (WDI_OID_PREFIX | (_MessageId))
#define WDI_DEFINE_INDICATION(_MessageId)   (WDI_INDICATION_PREFIX | (_MessageId))

#define OID_WDI_TASK_OPEN                           WDI_DEFINE_OID(WDI_TASK_OPEN)
#define OID_WDI_TASK_CLOSE                          WDI_DEFINE_OID(WDI_TASK_CLOSE)
#define OID_WDI_TASK_SCAN                           WDI_DEFINE_OID(WDI_TASK_SCAN)
#define OID_WDI_TASK_P2P_DISCOVER                   WDI_DEFINE_OID(WDI_TASK_P2P_DISCOVER)
#define OID_WDI_TASK_CONNECT                        WDI_DEFINE_OID(WDI_TASK_CONNECT)
#define OID_WDI_TASK_DOT11_RESET                    WDI_DEFINE_OID(WDI_TASK_DOT11_RESET)
#define OID_WDI_TASK_DISCONNECT                     WDI_DEFINE_OID(WDI_TASK_DISCONNECT)
#define OID_WDI_TASK_P2P_SEND_REQUEST_ACTION_FRAME  WDI_DEFINE_OID(WDI_TASK_P2P_SEND_REQUEST_ACTION_FRAME)
#define OID_WDI_TASK_P2P_SEND_RESPONSE_ACTION_FRAME WDI_DEFINE_OID(WDI_TASK_P2P_SEND_RESPONSE_ACTION_FRAME)
#define OID_WDI_TASK_SET_RADIO_STATE                WDI_DEFINE_OID(WDI_TASK_SET_RADIO_STATE)
#define OID_WDI_TASK_CREATE_PORT                    WDI_DEFINE_OID(WDI_TASK_CREATE_PORT)
#define OID_WDI_TASK_DELETE_PORT                    WDI_DEFINE_OID(WDI_TASK_DELETE_PORT)
#define OID_WDI_TASK_START_AP                       WDI_DEFINE_OID(WDI_TASK_START_AP)
#define OID_WDI_TASK_STOP_AP                        WDI_DEFINE_OID(WDI_TASK_STOP_AP)
#define OID_WDI_TASK_SEND_AP_ASSOCIATION_RESPONSE   WDI_DEFINE_OID(WDI_TASK_SEND_AP_ASSOCIATION_RESPONSE)
#define OID_WDI_SET_POWER_STATE                     WDI_DEFINE_OID(WDI_SET_POWER_STATE)
#define OID_WDI_SET_OPERATION_MODE                  WDI_DEFINE_OID(WDI_SET_OPERATION_MODE)
#define OID_WDI_SET_P2P_ADDITIONAL_IE               WDI_DEFINE_OID(WDI_SET_P2P_ADDITIONAL_IE)
#define OID_WDI_SET_P2P_LISTEN_STATE                WDI_DEFINE_OID(WDI_SET_P2P_LISTEN_STATE)
#define OID_WDI_SET_PRIVACY_EXEMPTION_LIST          WDI_DEFINE_OID(WDI_SET_PRIVACY_EXEMPTION_LIST)
#define OID_WDI_SET_ADD_CIPHER_KEYS                 WDI_DEFINE_OID(WDI_SET_ADD_CIPHER_KEYS)
#define OID_WDI_SET_DELETE_CIPHER_KEYS              WDI_DEFINE_OID(WDI_SET_DELETE_CIPHER_KEYS)
#define OID_WDI_SET_DEFAULT_KEY_ID                  WDI_DEFINE_OID(WDI_SET_DEFAULT_KEY_ID)
#define OID_WDI_SET_CONNECTION_QUALITY              WDI_DEFINE_OID(WDI_SET_CONNECTION_QUALITY)
#define OID_WDI_GET_STATISTICS                      WDI_DEFINE_OID(WDI_GET_STATISTICS)
#define OID_WDI_SET_RECEIVE_PACKET_FILTER           WDI_DEFINE_OID(WDI_SET_RECEIVE_PACKET_FILTER)
#define OID_WDI_GET_ADAPTER_CAPABILITIES            WDI_DEFINE_OID(WDI_GET_ADAPTER_CAPABILITIES)
#define OID_WDI_SET_NETWORK_LIST_OFFLOAD            WDI_DEFINE_OID(WDI_SET_NETWORK_LIST_OFFLOAD)
#define OID_WDI_SET_RECEIVE_COALESCING              WDI_DEFINE_OID(WDI_SET_RECEIVE_COALESCING)
#define OID_WDI_GET_BSS_ENTRY_LIST                  WDI_DEFINE_OID(WDI_GET_BSS_ENTRY_LIST)
#define OID_WDI_SET_AUTO_POWER_SAVE                 WDI_DEFINE_OID(WDI_SET_AUTO_POWER_SAVE)
#define OID_WDI_GET_AUTO_POWER_SAVE                 WDI_DEFINE_OID(WDI_GET_AUTO_POWER_SAVE)
#define OID_WDI_SET_ADD_WOL_PATTERN                 WDI_DEFINE_OID(WDI_SET_ADD_WOL_PATTERN)
#define OID_WDI_SET_REMOVE_WOL_PATTERN              WDI_DEFINE_OID(WDI_SET_REMOVE_WOL_PATTERN)
#define OID_WDI_SET_MULTICAST_LIST                  WDI_DEFINE_OID(WDI_SET_MULTICAST_LIST)
#define OID_WDI_SET_ADD_PM_PROTOCOL_OFFLOAD         WDI_DEFINE_OID(WDI_SET_ADD_PM_PROTOCOL_OFFLOAD)
#define OID_WDI_SET_REMOVE_PM_PROTOCOL_OFFLOAD      WDI_DEFINE_OID(WDI_SET_REMOVE_PM_PROTOCOL_OFFLOAD)
#define OID_WDI_SET_ADAPTER_CONFIGURATION           WDI_DEFINE_OID(WDI_SET_ADAPTER_CONFIGURATION)
#define OID_WDI_GET_RECEIVE_COALESCING_MATCH_COUNT  WDI_DEFINE_OID(WDI_GET_RECEIVE_COALESCING_MATCH_COUNT)
#define OID_WDI_SET_CLEAR_RECEIVE_COALESCING        WDI_DEFINE_OID(WDI_SET_CLEAR_RECEIVE_COALESCING)
#define OID_WDI_GET_PM_PROTOCOL_OFFLOAD             WDI_DEFINE_OID(WDI_GET_PM_PROTOCOL_OFFLOAD)
#define OID_WDI_SET_ADVERTISEMENT_INFORMATION       WDI_DEFINE_OID(WDI_SET_ADVERTISEMENT_INFORMATION)
#define OID_WDI_TASK_CHANGE_OPERATION_MODE          WDI_DEFINE_OID(WDI_TASK_CHANGE_OPERATION_MODE)
#define OID_WDI_TASK_DELETE_PEER_STATE              WDI_DEFINE_OID(WDI_TASK_DELETE_PEER_STATE)
#define OID_WDI_IHV_REQUEST                         WDI_DEFINE_OID(WDI_IHV_REQUEST)
#define OID_WDI_TASK_ROAM                           WDI_DEFINE_OID(WDI_TASK_ROAM)
#define OID_WDI_SET_FLUSH_BSS_ENTRY                 WDI_DEFINE_OID(WDI_SET_FLUSH_BSS_ENTRY)
#define OID_WDI_SET_ASSOCIATION_PARAMETERS          WDI_DEFINE_OID(WDI_SET_ASSOCIATION_PARAMETERS)
#define OID_WDI_GET_NEXT_ACTION_FRAME_DIALOG_TOKEN  WDI_DEFINE_OID(WDI_GET_NEXT_ACTION_FRAME_DIALOG_TOKEN)
#define OID_WDI_TASK_SEND_REQUEST_ACTION_FRAME      WDI_DEFINE_OID(WDI_TASK_SEND_REQUEST_ACTION_FRAME)
#define OID_WDI_TASK_SEND_RESPONSE_ACTION_FRAME     WDI_DEFINE_OID(WDI_TASK_SEND_RESPONSE_ACTION_FRAME)
#define OID_WDI_SET_TCP_OFFLOAD_PARAMETERS          WDI_DEFINE_OID(WDI_SET_TCP_OFFLOAD_PARAMETERS)
#define OID_WDI_TCP_RSC_STATISTICS                  WDI_DEFINE_OID(WDI_TCP_RSC_STATISTICS)
#define OID_WDI_SET_P2P_WPS_ENABLED                 WDI_DEFINE_OID(WDI_SET_P2P_WPS_ENABLED)
#define OID_WDI_SET_P2P_START_BACKGROUND_DISCOVERY  WDI_DEFINE_OID(WDI_SET_P2P_START_BACKGROUND_DISCOVERY)
#define OID_WDI_SET_P2P_STOP_BACKGROUND_DISCOVERY   WDI_DEFINE_OID(WDI_SET_P2P_STOP_BACKGROUND_DISCOVERY)
#define OID_WDI_TASK_IHV                            WDI_DEFINE_OID(WDI_TASK_IHV)
#define OID_WDI_SET_ENCAPSULATION_OFFLOAD           WDI_DEFINE_OID(WDI_SET_ENCAPSULATION_OFFLOAD)
#define OID_WDI_SET_END_DWELL_TIME                  WDI_DEFINE_OID(WDI_SET_END_DWELL_TIME)
#define OID_WDI_SET_FAST_BSS_TRANSITION_PARAMETERS  WDI_DEFINE_OID(WDI_SET_FAST_BSS_TRANSITION_PARAMETERS)
#define OID_WDI_SET_NEIGHBOR_REPORT_ENTRIES         WDI_DEFINE_OID(WDI_SET_NEIGHBOR_REPORT_ENTRIES)
#define OID_WDI_GET_SUPPORTED_DEVICE_SERVICES       WDI_DEFINE_OID(WDI_GET_SUPPORTED_DEVICE_SERVICES)
#define OID_WDI_DEVICE_SERVICE_COMMAND              WDI_DEFINE_OID(WDI_DEVICE_SERVICE_COMMAND)
#define OID_WDI_SET_SAE_AUTH_PARAMS                 WDI_DEFINE_OID(WDI_SET_SAE_AUTH_PARAMS)
#define OID_WDI_TASK_REQUEST_FTM                    WDI_DEFINE_OID(WDI_TASK_REQUEST_FTM)
#define OID_WDI_ABORT_TASK                          WDI_DEFINE_OID(WDI_ABORT_TASK)

#define NDIS_STATUS_WDI_INDICATION_DISCONNECT_COMPLETE                     WDI_DEFINE_INDICATION(WDI_INDICATION_DISCONNECT_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_SET_RADIO_STATE_COMPLETE                WDI_DEFINE_INDICATION(WDI_INDICATION_SET_RADIO_STATE_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_DISASSOCIATION                          WDI_DEFINE_INDICATION(WDI_INDICATION_DISASSOCIATION)
#define NDIS_STATUS_WDI_INDICATION_ROAMING_NEEDED                          WDI_DEFINE_INDICATION(WDI_INDICATION_ROAMING_NEEDED)
#define NDIS_STATUS_WDI_INDICATION_LINK_STATE_CHANGE                       WDI_DEFINE_INDICATION(WDI_INDICATION_LINK_STATE_CHANGE)
#define NDIS_STATUS_WDI_INDICATION_P2P_ACTION_FRAME_RECEIVED               WDI_DEFINE_INDICATION(WDI_INDICATION_P2P_ACTION_FRAME_RECEIVED)
#define NDIS_STATUS_WDI_INDICATION_AP_ASSOCIATION_REQUEST_RECEIVED         WDI_DEFINE_INDICATION(WDI_INDICATION_AP_ASSOCIATION_REQUEST_RECEIVED)
#define NDIS_STATUS_WDI_INDICATION_NLO_DISCOVERY                           WDI_DEFINE_INDICATION(WDI_INDICATION_NLO_DISCOVERY)
#define NDIS_STATUS_WDI_INDICATION_WAKE_REASON                             WDI_DEFINE_INDICATION(WDI_INDICATION_WAKE_REASON)
#define NDIS_STATUS_WDI_INDICATION_PMKID_CANDIDATE_LIST_UPDATE             WDI_DEFINE_INDICATION(WDI_INDICATION_PMKID_CANDIDATE_LIST_UPDATE)
#define NDIS_STATUS_WDI_INDICATION_TKIP_MIC_FAILURE                        WDI_DEFINE_INDICATION(WDI_INDICATION_TKIP_MIC_FAILURE)
#define NDIS_STATUS_WDI_INDICATION_ACTION_FRAME_RECEIVED                   WDI_DEFINE_INDICATION(WDI_INDICATION_ACTION_FRAME_RECEIVED)
#define NDIS_STATUS_WDI_INDICATION_SEND_REQUEST_ACTION_FRAME_COMPLETE      WDI_DEFINE_INDICATION(WDI_INDICATION_SEND_REQUEST_ACTION_FRAME_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_SEND_RESPONSE_ACTION_FRAME_COMPLETE     WDI_DEFINE_INDICATION(WDI_INDICATION_SEND_RESPONSE_ACTION_FRAME_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_SCAN_COMPLETE                           WDI_DEFINE_INDICATION(WDI_INDICATION_SCAN_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_P2P_DISCOVERY_COMPLETE                  WDI_DEFINE_INDICATION(WDI_INDICATION_P2P_DISCOVERY_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_BSS_ENTRY_LIST                          WDI_DEFINE_INDICATION(WDI_INDICATION_BSS_ENTRY_LIST)
#define NDIS_STATUS_WDI_INDICATION_DOT11_RESET_COMPLETE                    WDI_DEFINE_INDICATION(WDI_INDICATION_DOT11_RESET_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_CONNECT_COMPLETE                        WDI_DEFINE_INDICATION(WDI_INDICATION_CONNECT_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_P2P_SEND_REQUEST_ACTION_FRAME_COMPLETE  WDI_DEFINE_INDICATION(WDI_INDICATION_P2P_SEND_REQUEST_ACTION_FRAME_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_P2P_SEND_RESPONSE_ACTION_FRAME_COMPLETE WDI_DEFINE_INDICATION(WDI_INDICATION_P2P_SEND_RESPONSE_ACTION_FRAME_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_RADIO_STATUS                            WDI_DEFINE_INDICATION(WDI_INDICATION_RADIO_STATUS)
#define NDIS_STATUS_WDI_INDICATION_CREATE_PORT_COMPLETE                    WDI_DEFINE_INDICATION(WDI_INDICATION_CREATE_PORT_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_DELETE_PORT_COMPLETE                    WDI_DEFINE_INDICATION(WDI_INDICATION_DELETE_PORT_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_START_AP_COMPLETE                       WDI_DEFINE_INDICATION(WDI_INDICATION_START_AP_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_STOP_AP_COMPLETE                        WDI_DEFINE_INDICATION(WDI_INDICATION_STOP_AP_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_STOP_AP                                 WDI_DEFINE_INDICATION(WDI_INDICATION_STOP_AP)
#define NDIS_STATUS_WDI_INDICATION_CAN_SUSTAIN_AP                          WDI_DEFINE_INDICATION(WDI_INDICATION_CAN_SUSTAIN_AP)
#define NDIS_STATUS_WDI_INDICATION_SEND_AP_ASSOCIATION_RESPONSE_COMPLETE   WDI_DEFINE_INDICATION(WDI_INDICATION_SEND_AP_ASSOCIATION_RESPONSE_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_ASSOCIATION_RESULT                      WDI_DEFINE_INDICATION(WDI_INDICATION_ASSOCIATION_RESULT)
#define NDIS_STATUS_WDI_INDICATION_P2P_GROUP_OPERATING_CHANNEL             WDI_DEFINE_INDICATION(WDI_INDICATION_P2P_GROUP_OPERATING_CHANNEL)
#define NDIS_STATUS_WDI_INDICATION_CHANGE_OPERATION_MODE_COMPLETE          WDI_DEFINE_INDICATION(WDI_INDICATION_CHANGE_OPERATION_MODE_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_IHV_EVENT                               WDI_DEFINE_INDICATION(WDI_INDICATION_IHV_EVENT)
#define NDIS_STATUS_WDI_INDICATION_OPEN_COMPLETE                           WDI_DEFINE_INDICATION(WDI_INDICATION_OPEN_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_CLOSE_COMPLETE                          WDI_DEFINE_INDICATION(WDI_INDICATION_CLOSE_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_ROAM_COMPLETE                           WDI_DEFINE_INDICATION(WDI_INDICATION_ROAM_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_ASSOCIATION_PARAMETERS_REQUEST          WDI_DEFINE_INDICATION(WDI_INDICATION_ASSOCIATION_PARAMETERS_REQUEST)
#define NDIS_STATUS_WDI_INDICATION_TASK_OFFLOAD_CURRENT_CONFIG             WDI_DEFINE_INDICATION(WDI_INDICATION_TASK_OFFLOAD_CURRENT_CONFIG)
#define NDIS_STATUS_WDI_TCP_RSC_STATISTICS                                 WDI_DEFINE_INDICATION(WDI_TCP_RSC_STATISTICS)
#define NDIS_STATUS_WDI_INDICATION_P2P_OPERATING_CHANNEL_ATTRIBUTES        WDI_DEFINE_INDICATION(WDI_INDICATION_P2P_OPERATING_CHANNEL_ATTRIBUTES)
#define NDIS_STATUS_WDI_INDICATION_IHV_TASK_REQUEST                        WDI_DEFINE_INDICATION(WDI_INDICATION_IHV_TASK_REQUEST)
#define NDIS_STATUS_WDI_INDICATION_IHV_TASK_COMPLETE                       WDI_DEFINE_INDICATION(WDI_INDICATION_IHV_TASK_COMPLETE)
#define NDIS_STATUS_WDI_INDICATION_FIRMWARE_STALLED                        WDI_DEFINE_INDICATION(WDI_INDICATION_FIRMWARE_STALLED)
#define NDIS_STATUS_WDI_INDICATION_FT_ASSOC_PARAMS_NEEDED                  WDI_DEFINE_INDICATION(WDI_INDICATION_FT_ASSOC_PARAMS_NEEDED)
#define NDIS_STATUS_WDI_INDICATION_ADAPTER_STATE                           WDI_DEFINE_INDICATION(WDI_INDICATION_ADAPTER_STATE)
#define NDIS_STATUS_WDI_INDICATION_CIPHER_KEY_UPDATED                      WDI_DEFINE_INDICATION(WDI_INDICATION_CIPHER_KEY_UPDATED)
#define NDIS_STATUS_WDI_INDICATION_DEVICE_SERVICE_EVENT                    WDI_DEFINE_INDICATION(WDI_INDICATION_DEVICE_SERVICE_EVENT)
#define NDIS_STATUS_WDI_INDICATION_SAE_AUTH_PARAMS_NEEDED                  WDI_DEFINE_INDICATION(WDI_INDICATION_SAE_AUTH_PARAMS_NEEDED)
#define NDIS_STATUS_WDI_INDICATION_REQUEST_FTM_COMPLETE                    WDI_DEFINE_INDICATION(WDI_INDICATION_REQUEST_FTM_COMPLETE)

/* Addresses and the header every command, response and indication starts with */
...
/* The port a message about the whole adapter is addressed to */
#define WDI_PORT_ID_ADAPTER                 ((UINT16)-1)

/* Indications other than task completions carry this transaction id */
#define WDI_TRANSACTION_ID_UNSOLICIT        (0)

/* The message id and length come from the OID request or the status indication */
...
/* 0 to 15 are 802.11 TIDs, 16 is non QoS, 17 to 24 belong to the IHV, 31 is unknown */
...
/* Hints, what each level means is up to the IHV */
...
typedef enum _WDI_RX_INDICATION_LEVEL
{
    ...
    WDI_RX_INDICATION_DISPATCH_GENERAL_WITH_LOW_RESOURCES =
        WDI_RX_INDICATION_FLAG_RESOURCES | WDI_RX_INDICATION_DISPATCH_GENERAL,
    WDI_RX_INDICATION_DISPATCH_FIRST_OF_DPC_WITH_LOW_RESSOURCES =
        WDI_RX_INDICATION_FLAG_RESOURCES | WDI_RX_INDICATION_DISPATCH_FIRST_OF_DPC,
    WDI_RX_INDICATION_FROM_RX_RESUME_FRAMES_WITH_LOW_RESOURCES =
        WDI_RX_INDICATION_FLAG_RESOURCES | WDI_RX_INDICATION_FROM_RX_RESUME_FRAMES,
    WDI_RX_INDICATION_PASSIVE_WITH_LOW_RESOURCES =
        WDI_RX_INDICATION_FLAG_RESOURCES | WDI_RX_INDICATION_PASSIVE
...
/* Everything from here on is byte packed */
#include <pshpack1.h>
...
typedef
VOID
(NTAPI MINIPORT_WDI_TX_TARGET_DESC_INIT)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
...
typedef
VOID
(NTAPI MINIPORT_WDI_TX_TARGET_DESC_DEINIT)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ PNET_BUFFER_LIST NetBufferList);
...
typedef
VOID
(NTAPI MINIPORT_WDI_TX_DATA_SEND)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
...
typedef
VOID
(NTAPI MINIPORT_WDI_TX_TAL_SEND)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
    _In_ WDI_EXTENDED_TID ExTid,
...
typedef
VOID
(NTAPI MINIPORT_WDI_TX_TAL_SEND_COMPLETE)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ PNET_BUFFER_LIST NetBufferList,
...
typedef
VOID
(NTAPI MINIPORT_WDI_TX_TAL_QUEUE_IN_ORDER)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PEER_ID PeerId,
...
typedef
VOID
(NTAPI MINIPORT_WDI_TX_SUSPECT_FRAME_LIST_ABORT)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
...
typedef
VOID
(NTAPI MINIPORT_WDI_TX_PEER_BACKLOG)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
...
typedef
PWDI_FRAME_METADATA
(NTAPI NDIS_WDI_ALLOCATE_WDI_FRAME_METADATA)(
...
typedef
VOID
(NTAPI NDIS_WDI_FREE_WDI_FRAME_METADATA)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
...
/* What the transmit engine indicates up */

typedef
VOID
(NTAPI NDIS_WDI_TX_DEQUEUE_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ UINT32 Quantum,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_TRANSFER_COMPLETE_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_SEND_COMPLETE_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ WDI_TX_FRAME_STATUS WifiTxFrameStatus,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_QUERY_RA_TID_STATE)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
    _In_ WDI_EXTENDED_TID ExTid,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_QUERY_SUSPECT_FRAME_COMPLETE_STATUS)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ UINT64 SuspectFrameContext,
    _In_ PNET_BUFFER_LIST NetBufferList,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_SEND_PAUSE_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
    _In_ UINT32 ExTidBitmask,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_SEND_RESTART_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
    _In_ UINT32 ExTidBitmask,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_RELEASE_FRAMES_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
    _In_ UINT32 ExTidBitmask,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_INJECT_FRAME_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
    _In_ WDI_EXTENDED_TID ExTid,
...
typedef
VOID
(NTAPI NDIS_WDI_TX_ABORT_CONFIRM)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle);
...
typedef
VOID
(NTAPI MINIPORT_WDI_RX_GET_MPDUS)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PEER_ID PeerId,
    _In_ WDI_EXTENDED_TID ExTid,
    _Out_ PNET_BUFFER_LIST *NetBufferList);
...
typedef
VOID
(NTAPI MINIPORT_WDI_RX_RETURN_FRAMES)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ PNET_BUFFER_LIST NetBufferList);
...
typedef
VOID
(NTAPI MINIPORT_WDI_RX_RESUME)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext);
typedef MINIPORT_WDI_RX_RESUME *MINIPORT_WDI_RX_RESUME_HANDLER;

typedef
VOID
(NTAPI NDIS_WDI_RX_INORDER_DATA_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
...
typedef
VOID
(NTAPI MINIPORT_WDI_RX_THROTTLE)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
...
typedef
VOID
(NTAPI MINIPORT_WDI_RX_PPDU_RSSI)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ PNET_BUFFER_LIST NetBufferList,
    _Out_ UINT8 *Rssi);
...
typedef
NDIS_STATUS
(NTAPI MINIPORT_WDI_TAL_TXRX_START)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ PWDI_TXRX_TARGET_CONFIGURATION WifiTxRxConfiguration,
    _Out_ PTAL_TXRX_PARAMETERS TalTxRxParameters);
typedef MINIPORT_WDI_TAL_TXRX_START *MINIPORT_WDI_TAL_TXRX_START_HANDLER;

typedef
VOID
(NTAPI MINIPORT_WDI_TAL_TXRX_STOP)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext);
typedef MINIPORT_WDI_TAL_TXRX_STOP *MINIPORT_WDI_TAL_TXRX_STOP_HANDLER;

typedef
VOID
(NTAPI MINIPORT_WDI_TAL_TXRX_ADD_PORT)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId,
...
typedef
VOID
(NTAPI MINIPORT_WDI_TAL_TXRX_DELETE_PORT)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId);
...
typedef
VOID
(NTAPI MINIPORT_WDI_TAL_TXRX_SET_PORT_OPMODE)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_OPERATION_MODE Opmode);
...
typedef
VOID
(NTAPI MINIPORT_WDI_TAL_TXRX_RESET_PORT)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId);
...
typedef
VOID
(NTAPI MINIPORT_WDI_TAL_TXRX_PEER_CONFIG)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
    _In_ PWDI_TXRX_PEER_CFG PeerCfg);
typedef MINIPORT_WDI_TAL_TXRX_PEER_CONFIG *MINIPORT_WDI_TAL_TXRX_PEER_CONFIG_HANDLER;

typedef
VOID
(NTAPI MINIPORT_WDI_TAL_TXRX_PEER_DELETE_CONFIRM)(
    _In_ TAL_TXRX_HANDLE MiniportTalTxRxContext,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId);
...
typedef
VOID
(NTAPI NDIS_WDI_PEER_CREATE_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
...
typedef
VOID
(NTAPI NDIS_WDI_PEER_DELETE_IND)(
    _In_ NDIS_HANDLE NdisMiniportDataPathHandle,
    _In_ WDI_PORT_ID PortId,
    _In_ WDI_PEER_ID PeerId,
    _Out_ NDIS_STATUS *WifiStatus);
...
/* What the upper edge gives the miniport's data path */
...
/* What the miniport's data path gives the upper edge */
