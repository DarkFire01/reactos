...
#define NDIS_OBJECT_TYPE_MINIPORT_DRIVER_CHARACTERISTICS             0x0000008A
#define NDIS_OBJECT_TYPE_MINIPORT_INIT_PARAMETERS                    0x00000081
...
/* NDIS_MINIPORT_DRIVER_CHARACTERISTICS::Flags */
...
/* NDIS_MINIPORT_PAUSE_PARAMETERS::PauseReason */
...
/*
 * The remaining arms (NDK, hardware assist, PacketDirect) are dispatched on
...
/* Direct OIDs bypass the serialized OID queue, for hot path queries. */
typedef NDIS_STATUS (NTAPI MINIPORT_DIRECT_OID_REQUEST)(
    _In_ NDIS_HANDLE MiniportAdapterContext,
    _In_ PNDIS_OID_REQUEST OidRequest);
typedef MINIPORT_DIRECT_OID_REQUEST *MINIPORT_DIRECT_OID_REQUEST_HANDLER;

typedef VOID (NTAPI MINIPORT_CANCEL_DIRECT_OID_REQUEST)(
    _In_ NDIS_HANDLE MiniportAdapterContext,
    _In_ PVOID RequestId);
...
typedef NDIS_STATUS (NTAPI MINIPORT_SYNCHRONOUS_OID_REQUEST)(
    _In_ NDIS_HANDLE MiniportAdapterContext,
    _In_ PNDIS_OID_REQUEST OidRequest);
