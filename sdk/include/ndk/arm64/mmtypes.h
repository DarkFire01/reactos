...
#define MM_PAGE_FRAME_NUMBER_SIZE         36

/* Following structs are based on Win10 ARM64 (ntkrnlmp) symbols */
...
{
    /* 8 Byte struct - identical layout to HARDWARE_PTE;
       "Sharability" spelling matches Win10 ntkrnlmp symbols exactly */
    ULONG64 Valid:1;
    ULONG64 NotLargePage:1;
    ULONG64 CacheType:2;
    ULONG64 OsAvailable2:1;
