...
#if (NTDDI_VERSION >= NTDDI_WIN10_VB) || defined(__REACTOS__)
...
typedef enum _POOL_EXTENDED_PARAMETER_TYPE {
  ...
  PoolExtendedParameterPreferredNode,
...
typedef struct DECLSPEC_ALIGN(8) _POOL_EXTENDED_PARAMETER {
  struct {
    ULONG64 Type : POOL_EXTENDED_PARAMETER_TYPE_BITS;
    ULONG64 Optional : 1;
    ULONG64 Reserved : 64 - 1 - POOL_EXTENDED_PARAMETER_TYPE_BITS;
  } DUMMYSTRUCTNAME;
  union {
    ULONG64 Reserved2;
    PVOID Reserved3;
    EX_POOL_PRIORITY Priority;
    PPOOL_EXTENDED_PARAMS_SECURE_POOL SecurePoolParams;
    ULONG NumaNode;
    ULONG PreferredNode;
  } DUMMYUNIONNAME;
...
#endif /* (NTDDI_VERSION >= NTDDI_WIN10_VB) || defined(__REACTOS__) */
