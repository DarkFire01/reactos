...
{
    DPRINT1("VidSetupUefi Entry\n");
    refiFbData.BaseAddress        = LoaderBlock->BaseAddress      ;
    refiFbData.BufferSize         = LoaderBlock->BufferSize       ;
    refiFbData.ScreenWidth        = LoaderBlock->ScreenWidth      ;
    refiFbData.ScreenHeight       = LoaderBlock->ScreenHeight     ;
    refiFbData.PixelsPerScanLine  = LoaderBlock->PixelsPerScanLine;
    refiFbData.PixelFormat        = LoaderBlock->PixelFormat      ;
}
