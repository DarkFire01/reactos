...
/* The extensions reach these import slots by offset as well */
#ifdef _WIN64
C_ASSERT(FIELD_OFFSET(KDNET_EXTENSIBILITY_IMPORTS, SetHiberRange) == 0xB0);
C_ASSERT(FIELD_OFFSET(KDNET_EXTENSIBILITY_IMPORTS, KdNetDbgPrintf) == 0xD8);
C_ASSERT(FIELD_OFFSET(KDNET_EXTENSIBILITY_IMPORTS, KdNetErrorString) == 0x100);
C_ASSERT(FIELD_OFFSET(KDNET_EXTENSIBILITY_IMPORTS, KdNetHardwareID) == 0x108);
#endif
