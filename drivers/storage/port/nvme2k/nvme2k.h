...
//
// Forward declarations of miniport entry points (NTAPI = __stdcall for port driver callbacks)
//
ULONG NTAPI DriverEntry(IN PVOID DriverObject, IN PVOID Argument2);
ULONG NTAPI HwFindAdapter(IN PVOID DeviceExtension, IN PVOID HwContext,
...
SCSI_ADAPTER_CONTROL_STATUS NTAPI HwAdapterControl(IN PVOID DeviceExtension,
