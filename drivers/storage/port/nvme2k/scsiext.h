...
//
// SCSI UNMAP structures are defined in scsi.h (included via nvme2k.h).
// Only define here when scsi.h has not been included (e.g. standalone build).
//
#ifndef _SCSI_UNMAP_STRUCTS_DEFINED_
#pragma pack(push, 1)
...
#pragma pack(pop)
#endif /* !_SCSI_UNMAP_STRUCTS_DEFINED_ */
