    ...
    _Out_ ULONG* OutDataLen)
{
    ...
    if (!(GetFlags & 0x08000000) && (DeviceExtension->Flags & 0x0000004000000000))
    {
        ...
        swprintf(String, L"%lx", (unsigned long)AmliData->DataValue);
        goto Exit;
    }
    ...
    swprintf(String, L"%S", (char*)AmliData->DataBuff);
    goto Exit;
    ...
    _Out_ ULONG* OutDataLen)
{
    ...
    if (!(GetFlags & 0x08000000) && (DeviceExtension->Flags & 0x8000000000000000))
    {
        ...
        swprintf(CompatibleId, L"%S", (char*)DeviceExtension->Button.SpinLock);
