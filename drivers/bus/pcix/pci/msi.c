...
PciGetMessageAddressAndData(
    ...
    _Out_ PULONG Data)
{
    HAL_MESSAGE_SIGNAL_TARGET_REQUEST Request;
    ...
    Request.InterruptVector = VectorData->Vector;
    Request.TargetProcessors = VectorData->TargetProcessors;
    Request.ApicDestinationMode = VectorData->MessageRequest.DestinationMode;
    Request.InterruptRemapInfo = VectorData->IntRemapInfo;
