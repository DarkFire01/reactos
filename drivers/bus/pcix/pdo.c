    ...
    _In_ BOOLEAN Read)
{
    ...
    Status = PciAccessDeviceSpace(DeviceExtension,
                                  IoStackLocation->Parameters.ReadWriteConfig.WhichSpace,
                                  IoStackLocation->Parameters.ReadWriteConfig.Buffer,
                                  IoStackLocation->Parameters.ReadWriteConfig.Offset,
                                  IoStackLocation->Parameters.ReadWriteConfig.Length,
                                  Read);
    if (NT_SUCCESS(Status))
        Irp->IoStatus.Information = IoStackLocation->Parameters.ReadWriteConfig.Length;
