...
/*
 * NDIS 6 entry points for an NDIS 5 miniport, with the adapter as context.
 * NET_BUFFER_LISTs become packets going down, and packets and lookahead
 * indications become NET_BUFFER_LISTs going up.
 */
