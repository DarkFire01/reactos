                   ...
                   IN NDIS_HANDLE WrapperConfigurationContext)
{
    ...
    Status = NdisAllocateMemoryWithTag((PVOID*)&Adapter, sizeof(*Adapter), I21X_TAG);
    ...
    Status = NdisAllocateMemoryWithTag((PVOID*)&ResourceList, ResourceListSize, I21X_TAG);
    if (Status != NDIS_STATUS_SUCCESS)
    {
