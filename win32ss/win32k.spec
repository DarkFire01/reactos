...
@ stdcall EngAcquireSemaphoreSharedNoWait(ptr)
...
@ stdcall EngCTGetCurrentGamma(ptr)
@ stdcall EngCTGetGammaTable(long ptr ptr)
...
@ stdcall EngIsSemaphoreSharedByCurrentThread(ptr)
@ stdcall EngIsCddDeviceBitmap(ptr)
...
@ stdcall EngUpdateDeviceSurface(ptr ptr)
@ stdcall EngQueryW32kCddInterface(ptr ptr ptr ptr ptr ptr)
