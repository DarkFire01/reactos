 ...
 * PURPOSE:     DrvEnableDriver and PDEV lifecycle
 *
 * Forked from win32ss/drivers/displays/framebuf/enable.c (Copyright 2004 Filip
 * Navara, GPLv2+) with the function table extended for BitBlt / CopyBits /
 * Escape acceleration paths.
 */
