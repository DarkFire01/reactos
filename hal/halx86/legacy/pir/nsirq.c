...
/* The NS87560 steers INTA to INTD through the nibbles at 0x6C and 0x6D */
#define NS87560_INT_REGISTER        0x6C
#define NS87560_INT_LINKS           4

/* It keeps its own edge/level register, IRQs 0 to 7 at 0x67 and 8 to 15 at 0x68 */
    ...
    _In_ UCHAR Irq)
{
    ...
    Register = HalpPirPairRegister(NS87560_INT_REGISTER, Link);
    Value = HalpPirSetNibble(HalpPirReadRouterByte(Register), HalpPirPairHighNibble(Link), Irq);
