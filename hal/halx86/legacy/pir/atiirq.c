...
/* Indexes of the PCI lines. The two they skip over drive the SCI and the SMBus */
...
/* The BIOS numbers a link one past the index that selects it, as zero ends a pin */
static
BOOLEAN
HalpAtiLocateLink(
    _In_ UCHAR Link,
