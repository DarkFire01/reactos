    ...
    _Out_ PIO_RESOURCE_DESCRIPTOR *Target)
{
    ...
    if (HalpLegacyPCArbitratesIrqs())
        return HalpLegacyTranslateVectorRange(Context, Source, PhysicalDeviceObject, TargetCount, Target);
    ...
    _Out_ PULONG Length)
{
    ...
    *Length = sizeof(TRANSLATOR_INTERFACE);
    ...
    HalpFillIrqTranslator(Interface, BusFdo, HalpLegacyTranslateBusLine, HalpLegacyTranslateBusLineRange);
    return STATUS_SUCCESS;
}
    ...
    _Out_ PULONG BridgeBusNumber)
{
    ...
    switch (BridgeInterfaceType)
    {
        ...
        case Isa:
        case Eisa:
            HalpFillIrqTranslator(Translator, NULL, HalpLegacyTranslateIsaLine, HalpLegacyTranslateIsaRange);
            return STATUS_SUCCESS;
        ...
        case PCIBus:
            ...
            HalpFillIrqTranslator(Translator, NULL, HalpLegacyTranslateVector, HalpLegacyTranslateVectorRange);
            return STATUS_SUCCESS;
