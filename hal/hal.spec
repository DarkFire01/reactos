...
@ stdcall -arch=i386,x86_64 HalAllocateHardwareCounters(ptr long ptr ptr)
...
@ stdcall -arch=i386,x86_64 -version=0x601+ HalBugCheckSystem(ptr ptr)
@ stdcall -arch=i386,x86_64 -version=0x000-0x600 HalBugCheckSystem(ptr)
...
@ stdcall -arch=i386,x86_64 HalEnumerateEnvironmentVariablesEx(long ptr ptr)
@ stdcall HalFlushCommonBuffer(long long long long long)
@ stdcall -arch=i386,x86_64 HalFreeHardwareCounters(ptr)
...
@ stdcall -arch=i386,x86_64 HalGetEnvironmentVariableEx(wstr ptr ptr ptr ptr)
...
@ stdcall -arch=i386,x86_64 HalInitializeBios(long ptr)
...
@ stdcall -arch=i386,x86_64 HalQueryEnvironmentVariableInfoEx(long ptr ptr ptr)
@ stdcall -arch=i386,x86_64 HalQueryMaximumProcessorCount()
@ stdcall HalQueryRealTimeClock(ptr)
@ stdcall HalReadDmaCounter(ptr)
@ stdcall -arch=i386,x86_64 HalRegisterDynamicProcessor(long long)
@ stdcall -arch=i386,x86_64 HalRegisterErrataCallbacks()
...
@ stdcall -arch=i386,x86_64 HalSetEnvironmentVariableEx(wstr ptr ptr long long)
