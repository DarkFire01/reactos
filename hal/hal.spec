...
@ stdcall -version=0x0601+ -arch=i386,x86_64 HalAllocateHardwareCounters(ptr long ptr ptr)
...
@ stdcall -version=0x0600+ -arch=i386,x86_64 HalBugCheckSystem(ptr)
...
@ stdcall -version=0x0600+ -arch=i386,x86_64 HalGetEnvironmentVariableEx(wstr ptr ptr ptr ptr)
@ fastcall -arch=arm HalGetInterruptSource()
@ stdcall -arch=i386,x86_64 HalGetInterruptTargetInformation(long long ptr)
@ stdcall HalGetInterruptVector(long long long long ptr ptr)
@ stdcall -arch=i386,x86_64 HalGetMessageRoutingInfo(ptr ptr)
@ stdcall -arch=i386,x86_64 HalGetProcessorIdByNtNumber(long ptr)
@ stdcall -arch=i386,x86_64 HalGetVectorInput(long long ptr ptr)
...
@ stdcall -version=0x0600+ -arch=i386,x86_64 HalQueryEnvironmentVariableInfoEx(long ptr ptr ptr)
@ stdcall -version=0x0600+ -arch=i386,x86_64 HalQueryMaximumProcessorCount()
@ stdcall HalQueryRealTimeClock(ptr)
@ stdcall HalReadDmaCounter(ptr)
@ stdcall -version=0x0600+ -arch=i386,x86_64 HalRegisterDynamicProcessor(long long)
@ stdcall -version=0x0600+ -arch=i386,x86_64 HalRegisterErrataCallbacks()
...
@ stdcall -version=0x0600+ -arch=i386,x86_64 HalSetEnvironmentVariableEx(wstr ptr ptr long long)
