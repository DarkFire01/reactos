...
@ stdcall -arch=i386,x86_64 HalAllocateMessageVectorBlock(long ptr ptr ptr)
@ stdcall -arch=i386,x86_64 HalGetMessageVectorMessage(long long ptr ptr)
@ stdcall -arch=i386,x86_64 HalGetMessageVectorIrql(long)
@ stdcall -arch=i386,x86_64 HalFreeMessageVector(long)
