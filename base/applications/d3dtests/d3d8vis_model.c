 ...
 * PURPOSE:     Direct3D 8 visual: a lit octahedron model
 */
...
int main(int argc, char **argv)
{
    ...
    test_begin("d3d8vis_model");

    hwnd = vis_create_window("Direct3D 8: lit octahedron");
    ...
    material.Diffuse.r = 0.9f; material.Diffuse.g = 0.7f; material.Diffuse.b = 0.35f;
    ...
    IDirect3DDevice8_LightEnable(s.device, 0, TRUE);

    IDirect3DDevice8_SetRenderState(s.device, D3DRS_LIGHTING, TRUE);
    IDirect3DDevice8_SetRenderState(s.device, D3DRS_AMBIENT, 0xff303030);
