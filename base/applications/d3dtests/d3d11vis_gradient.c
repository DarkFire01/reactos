 ...
 * PURPOSE:     Direct3D 11 visual: a gradient texture on the cube
 */
...
int main(int argc, char **argv)
{
    ...
    test_begin("d3d11vis_gradient");

    hwnd = vis_create_window("Direct3D 11: gradient-textured cube");
    ...
    if (n) vis_check_rendered(sample, n, 0xff140d0d);
