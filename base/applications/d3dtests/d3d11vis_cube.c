 ...
 * PURPOSE:     Direct3D 11 visual: a shaded rotating cube
 */
...
int main(int argc, char **argv)
{
    ...
    float clear[4] = { 0.125f, 0.16f, 0.22f, 1.0f };
    ...
    test_begin("d3d11vis_cube");

    hwnd = vis_create_window("Direct3D 11: rotating cube");
    ...
    if (!(vsb = d11_compile(hlsl_vs, "vs_4_0")) || !(psb = d11_compile(hlsl_ps_colour, "ps_4_0")))
    {
    ...
    if (n) vis_check_rendered(sample, n, 0xff382820);
