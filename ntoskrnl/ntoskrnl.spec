...
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwAccessCheckAndAuditAlarm(ptr ptr ptr ptr ptr long ptr long ptr ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwAddBootEntry(ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwAddDriverEntry(ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwAdjustPrivilegesToken(ptr long ptr long ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwAlertThread(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwAllocateVirtualMemory(ptr ptr long ptr long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwAssignProcessToJobObject(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCancelIoFile(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCancelTimer(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwClearEvent(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwClose(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCloseObjectAuditAlarm(ptr ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwConnectPort(ptr ptr ptr ptr ptr ptr ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCreateDirectoryObject(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCreateEvent(ptr long ptr long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCreateFile(ptr long ptr ptr ptr long long long long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCreateJobObject(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCreateKey(ptr long ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCreateSection(ptr long ptr ptr long long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCreateSymbolicLinkObject(ptr long ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwCreateTimer(ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDeleteBootEntry(long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDeleteDriverEntry(long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDeleteFile(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDeleteKey(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDeleteValueKey(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDeviceIoControlFile(ptr ptr ptr ptr ptr long ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDisplayString(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDuplicateObject(ptr ptr ptr ptr long long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwDuplicateToken(ptr long ptr long long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwEnumerateBootEntries(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwEnumerateDriverEntries(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwEnumerateKey(ptr long long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwEnumerateValueKey(ptr long long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwFlushInstructionCache(ptr ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwFlushKey(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwFlushVirtualMemory(ptr ptr ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwFreeVirtualMemory(ptr ptr ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwFsControlFile(ptr ptr ptr ptr ptr long ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwInitiatePowerAction(long long long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwIsProcessInJob(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwLoadDriver(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwLoadKey(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwMakeTemporaryObject(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwMapViewOfSection(ptr ptr ptr long long ptr ptr long long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwModifyBootEntry(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwModifyDriverEntry(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwNotifyChangeKey(ptr ptr ptr ptr ptr long long ptr long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenDirectoryObject(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenEvent(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenFile(ptr long ptr ptr long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenJobObject(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenKey(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenProcess(ptr long ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenProcessToken(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenProcessTokenEx(ptr long long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenSection(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenSymbolicLinkObject(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenThread(ptr long ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenThreadToken(ptr long long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenThreadTokenEx(ptr long long long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwOpenTimer(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwPowerInformation(long ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwPulseEvent(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryBootEntryOrder(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryBootOptions(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryDefaultLocale(long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryDefaultUILanguage(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryDirectoryFile(ptr ptr ptr ptr ptr ptr long long long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryDirectoryObject(ptr ptr long long long ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryDriverEntryOrder(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryEaFile(ptr ptr ptr long long ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryFullAttributesFile(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryInformationFile(ptr ptr ptr long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryInformationJobObject(ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryInformationProcess(ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryInformationThread(ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryInformationToken(ptr long long long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryInstallUILanguage(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryKey(ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryObject(ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQuerySection(ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQuerySecurityObject(ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQuerySymbolicLinkObject(ptr ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQuerySystemInformation(long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryValueKey(ptr ptr long ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwQueryVolumeInformationFile(ptr ptr ptr long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwReadFile(ptr ptr ptr ptr ptr ptr long ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwReplaceKey(ptr ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwRequestWaitReplyPort(ptr ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwResetEvent(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwRestoreKey(ptr ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSaveKey(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSaveKeyEx(ptr ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSecureConnectPort(ptr ptr ptr ptr ptr ptr ptr ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetBootEntryOrder(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetBootOptions(ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetDefaultLocale(long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetDefaultUILanguage(long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetDriverEntryOrder(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetEaFile(ptr ptr ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetEvent(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetInformationFile(ptr ptr ptr long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetInformationJobObject(ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetInformationObject(ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetInformationProcess(ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetInformationThread(ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetSecurityObject(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetSystemInformation(long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetSystemTime(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetTimer(ptr ptr ptr ptr long long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetValueKey(ptr ptr long long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwSetVolumeInformationFile(ptr ptr ptr long long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwTerminateJobObject(ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwTerminateProcess(ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwTranslateFilePath(ptr long ptr long)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwUnloadDriver(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwUnloadKey(ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwUnmapViewOfSection(ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwWaitForMultipleObjects(long ptr long long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwWaitForSingleObject(ptr long ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwWriteFile(ptr ptr ptr ptr ptr ptr long ptr ptr)
; TODO: ARM64 SYSCALLS BROKEN @ stdcall ZwYieldExecution()
