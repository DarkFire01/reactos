...
@ stdcall -stub DbgkLkmdRegisterCallback()
@ stdcall DbgLoadImageSymbols(ptr ptr long)
@ varargs DbgPrint(str)
@ varargs DbgPrintEx(long long str)
@ stdcall RtlIsNtDdiVersionAvailable(long) RtlIsNtDdiVersionAvailable_nt
...
@ stdcall -stub EmProviderDeregister()
@ stdcall -stub EmProviderRegister()
@ stdcall -stub EmClientQueryRuleState()
...
@ stdcall EtwWriteTransfer(int64 ptr ptr ptr long ptr)
...
@ stdcall -stub ExRegisterExtension(ptr long ptr)
...
@ stdcall -stub ExUnregisterExtension(ptr)
...
@ stdcall -stub IoSetIoCompletionEx()
@ fastcall IoSetPartitionInformation(ptr long long long)
@ stdcall IoSetPartitionInformationEx(ptr long ptr)
@ stdcall IoSetDeviceInterfacePropertyData(ptr ptr ptr long ptr long ptr)
...
@ stdcall -stub KeGetProcessorIndexFromNumber(ptr)
...
@ stdcall -arch=x86_64 KeInitializeSpinLock(ptr) _KeInitializeSpinLock
...
@ stdcall KeQueryActiveProcessorCount(long)
...
@ stdcall KeQueryLogicalProcessorRelationship(ptr ptr ptr ptr)
...
@ stdcall -stub KseRegisterShim(ptr ptr long)
...
@ stdcall -stub LpcRequestWaitReplyPortEx(ptr ptr ptr)
...
@ stdcall MmAllocateContiguousMemorySpecifyCacheNode(long long long long long long long long long)
@ stdcall MmAllocateMappingAddress(long long)
@ stdcall MmAllocateContiguousNodeMemory(long int64 int64 int64 long long)
...
@ stdcall -stub NtAlpcCancelMessage(ptr long ptr)
@ stdcall -stub NtAlpcConnectPort(ptr wstr ptr ptr long ptr ptr long ptr ptr ptr)
@ stdcall -stub NtAlpcCreatePortSection(ptr long ptr long ptr long)
@ stdcall -stub NtAlpcCreateResourceReserve(ptr long long ptr)
@ stdcall -stub NtAlpcCreateSectionView(ptr long ptr)
@ stdcall -stub NtAlpcCreateSecurityContext(ptr long ptr)
@ stdcall -stub NtAlpcDeletePortSection(ptr long ptr)
@ stdcall -stub NtAlpcDeleteSectionView(ptr long ptr)
@ stdcall -stub NtAlpcDeleteSecurityContext(ptr long ptr)
@ stdcall -stub NtAlpcDisconnectPort(ptr long)
@ stdcall -stub NtAlpcQueryInformation(ptr ptr ptr long long)
@ stdcall -stub NtAlpcSendWaitReceivePort(ptr long ptr ptr ptr long ptr ptr)
@ stdcall -stub NtAlpcSetInformation(ptr ptr ptr long)
...
@ stdcall -stub PoDisableSleepStates()
...
@ stdcall -stub PoUserShutdownInitiated()
...
@ stdcall -stub RtlCheckPortableOperatingSystem(long)
...
@ stdcall RtlGetIntegerAtom(wstr long)
...
@ stdcall -stub RtlGetThreadLangIdByIndex()
...
@ stdcall RtlQueryElevationFlags(long)
...
@ stdcall -stub RtlSetPortableOperatingSystem(long)
...
@ stdcall ZwAlpcCancelMessage(ptr long ptr) NtAlpcCancelMessage
@ stdcall ZwAlpcConnectPort(ptr wstr ptr ptr long ptr ptr long ptr ptr ptr) NtAlpcConnectPort
@ stdcall ZwAlpcConnectPortEx(ptr wstr ptr ptr long ptr ptr long ptr ptr ptr) NtAlpcConnectPort
@ stdcall ZwAlpcCreatePortSection(ptr long ptr long ptr long) NtAlpcCreatePortSection
@ stdcall ZwAlpcCreateResourceReserve(ptr long long ptr) NtAlpcCreateResourceReserve
@ stdcall ZwAlpcCreateSectionView(ptr long ptr) NtAlpcCreateSectionView
@ stdcall ZwAlpcCreateSecurityContext(ptr long ptr) NtAlpcCreateSecurityContext
@ stdcall ZwAlpcDeletePortSection(ptr long ptr) NtAlpcDeletePortSection
@ stdcall ZwAlpcDeleteSectionView(ptr long ptr) NtAlpcDeleteSectionView
@ stdcall ZwAlpcDeleteSecurityContext(ptr long ptr) NtAlpcDeleteSecurityContext
@ stdcall ZwAlpcDisconnectPort(ptr long) NtAlpcDisconnectPort
@ stdcall ZwAlpcQueryInformation(ptr ptr ptr long long) NtAlpcQueryInformation
@ stdcall ZwAlpcSendWaitReceivePort(ptr long ptr ptr ptr long ptr ptr) NtAlpcSendWaitReceivePort
@ stdcall ZwAlpcSetInformation(ptr ptr ptr long) NtAlpcSetInformation
...
@ stdcall ZwImpersonateAnonymousToken(ptr) NtImpersonateAnonymousToken
...
@ stdcall ZwRemoveIoCompletionEx(ptr ptr long ptr ptr long) NtRemoveIoCompletionEx
...
@ stub swprintf_s
@ cdecl _vsnprintf()
@ cdecl -stub _vsnprintf_s(ptr wstr ptr)
@ cdecl _vsnwprintf()
;@ cdecl -stub _vswprintf(ptr wstr ptr)
@ cdecl _wcsicmp()
@ cdecl _wcslwr()
@ cdecl _wcsnicmp()
@ cdecl _wcsnset()
...
@ cdecl strcmp()
@ cdecl strcpy()
@ cdecl -stub strcpy_s(ptr long str)
@ cdecl strlen()
@ cdecl strncat()
@ cdecl strncmp()
@ cdecl strncpy()
