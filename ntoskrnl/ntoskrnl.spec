...
@ stdcall -stub ZwAccessCheckAndAuditAlarm(ptr ptr ptr ptr ptr long ptr long ptr ptr ptr)
@ stdcall -stub ZwAddBootEntry(ptr long)
@ stdcall -stub ZwAddDriverEntry(ptr long)
@ stdcall -stub ZwAdjustPrivilegesToken(ptr long ptr long ptr ptr)
@ stdcall -stub ZwAlertThread(ptr)
@ stdcall -stub ZwAllocateVirtualMemory(ptr ptr long ptr long long)
@ stdcall -stub ZwAssignProcessToJobObject(ptr ptr)
@ stdcall -stub ZwCancelIoFile(ptr ptr)
@ stdcall -stub ZwCancelTimer(ptr ptr)
@ stdcall -stub ZwClearEvent(ptr)
@ stdcall -stub ZwClose(ptr)
@ stdcall -stub ZwCloseObjectAuditAlarm(ptr ptr long)
@ stdcall -stub ZwConnectPort(ptr ptr ptr ptr ptr ptr ptr ptr)
@ stdcall -stub ZwCreateDirectoryObject(ptr long ptr)
@ stdcall -stub ZwCreateEvent(ptr long ptr long long)
@ stdcall -stub ZwCreateFile(ptr long ptr ptr ptr long long long long ptr long)
@ stdcall -stub ZwCreateJobObject(ptr long ptr)
@ stdcall -stub ZwCreateKey(ptr long ptr long ptr long ptr)
@ stdcall -stub ZwCreateSection(ptr long ptr ptr long long ptr)
@ stdcall -stub ZwCreateSymbolicLinkObject(ptr long ptr ptr)
@ stdcall -stub ZwCreateTimer(ptr long ptr long)
@ stdcall -stub ZwDeleteBootEntry(long)
@ stdcall -stub ZwDeleteDriverEntry(long)
@ stdcall -stub ZwDeleteFile(ptr)
@ stdcall -stub ZwDeleteKey(ptr)
@ stdcall -stub ZwDeleteValueKey(ptr ptr)
@ stdcall -stub ZwDeviceIoControlFile(ptr ptr ptr ptr ptr long ptr long ptr long)
@ stdcall -stub ZwDisplayString(ptr)
@ stdcall -stub ZwDuplicateObject(ptr ptr ptr ptr long long long)
@ stdcall -stub ZwDuplicateToken(ptr long ptr long long ptr)
@ stdcall -stub ZwEnumerateBootEntries(ptr ptr)
@ stdcall -stub ZwEnumerateDriverEntries(ptr ptr)
@ stdcall -stub ZwEnumerateKey(ptr long long ptr long ptr)
@ stdcall -stub ZwEnumerateValueKey(ptr long long ptr long ptr)
@ stdcall -stub ZwFlushInstructionCache(ptr ptr long)
@ stdcall -stub ZwFlushKey(ptr)
@ stdcall -stub ZwFlushVirtualMemory(ptr ptr ptr ptr)
@ stdcall -stub ZwFreeVirtualMemory(ptr ptr ptr long)
@ stdcall -stub ZwFsControlFile(ptr ptr ptr ptr ptr long ptr long ptr long)
@ stdcall -stub ZwInitiatePowerAction(long long long long)
@ stdcall -stub ZwIsProcessInJob(ptr ptr)
@ stdcall -stub ZwLoadDriver(ptr)
@ stdcall -stub ZwLoadKey(ptr ptr)
@ stdcall -stub ZwMakeTemporaryObject(ptr)
@ stdcall -stub ZwMapViewOfSection(ptr ptr ptr long long ptr ptr long long long)
@ stdcall -stub ZwModifyBootEntry(ptr)
@ stdcall -stub ZwModifyDriverEntry(ptr)
@ stdcall -stub ZwNotifyChangeKey(ptr ptr ptr ptr ptr long long ptr long long)
@ stdcall -stub ZwOpenDirectoryObject(ptr long ptr)
@ stdcall -stub ZwOpenEvent(ptr long ptr)
@ stdcall -stub ZwOpenFile(ptr long ptr ptr long long)
@ stdcall -stub ZwOpenJobObject(ptr long ptr)
@ stdcall -stub ZwOpenKey(ptr long ptr)
@ stdcall -stub ZwOpenProcess(ptr long ptr ptr)
@ stdcall -stub ZwOpenProcessToken(ptr long ptr)
@ stdcall -stub ZwOpenProcessTokenEx(ptr long long ptr)
@ stdcall -stub ZwOpenSection(ptr long ptr)
@ stdcall -stub ZwOpenSymbolicLinkObject(ptr long ptr)
@ stdcall -stub ZwOpenThread(ptr long ptr ptr)
@ stdcall -stub ZwOpenThreadToken(ptr long long ptr)
@ stdcall -stub ZwOpenThreadTokenEx(ptr long long long ptr)
@ stdcall -stub ZwOpenTimer(ptr long ptr)
@ stdcall -stub ZwPowerInformation(long ptr long ptr long)
@ stdcall -stub ZwPulseEvent(ptr ptr)
@ stdcall -stub ZwQueryBootEntryOrder(ptr ptr)
@ stdcall -stub ZwQueryBootOptions(ptr ptr)
@ stdcall -stub ZwQueryDefaultLocale(long ptr)
@ stdcall -stub ZwQueryDefaultUILanguage(ptr)
@ stdcall -stub ZwQueryDirectoryFile(ptr ptr ptr ptr ptr ptr long long long ptr long)
@ stdcall -stub ZwQueryDirectoryObject(ptr ptr long long long ptr ptr)
@ stdcall -stub ZwQueryDriverEntryOrder(ptr ptr)
@ stdcall -stub ZwQueryEaFile(ptr ptr ptr long long ptr long ptr long)
@ stdcall -stub ZwQueryFullAttributesFile(ptr ptr)
@ stdcall -stub ZwQueryInformationFile(ptr ptr ptr long long)
@ stdcall -stub ZwQueryInformationJobObject(ptr long ptr long ptr)
@ stdcall -stub ZwQueryInformationProcess(ptr long ptr long ptr)
@ stdcall -stub ZwQueryInformationThread(ptr long ptr long ptr)
@ stdcall -stub ZwQueryInformationToken(ptr long long long ptr)
@ stdcall -stub ZwQueryInstallUILanguage(ptr)
@ stdcall -stub ZwQueryKey(ptr long ptr long ptr)
@ stdcall -stub ZwQueryObject(ptr long ptr long ptr)
@ stdcall -stub ZwQuerySection(ptr long ptr long ptr)
@ stdcall -stub ZwQuerySecurityObject(ptr long ptr long ptr)
@ stdcall -stub ZwQuerySymbolicLinkObject(ptr ptr ptr)
@ stdcall -stub ZwQuerySystemInformation(long ptr long ptr)
@ stdcall -stub ZwQueryValueKey(ptr ptr long ptr long ptr)
@ stdcall -stub ZwQueryVolumeInformationFile(ptr ptr ptr long long)
@ stdcall -stub ZwReadFile(ptr ptr ptr ptr ptr ptr long ptr ptr)
@ stdcall -stub ZwReplaceKey(ptr ptr ptr)
@ stdcall -stub ZwRequestWaitReplyPort(ptr ptr ptr)
@ stdcall -stub ZwResetEvent(ptr ptr)
@ stdcall -stub ZwRestoreKey(ptr ptr long)
@ stdcall -stub ZwSaveKey(ptr ptr)
@ stdcall -stub ZwSaveKeyEx(ptr ptr long)
@ stdcall -stub ZwSecureConnectPort(ptr ptr ptr ptr ptr ptr ptr ptr ptr)
@ stdcall -stub ZwSetBootEntryOrder(ptr ptr)
@ stdcall -stub ZwSetBootOptions(ptr long)
@ stdcall -stub ZwSetDefaultLocale(long long)
@ stdcall -stub ZwSetDefaultUILanguage(long)
@ stdcall -stub ZwSetDriverEntryOrder(ptr ptr)
@ stdcall -stub ZwSetEaFile(ptr ptr ptr long)
@ stdcall -stub ZwSetEvent(ptr ptr)
@ stdcall -stub ZwSetInformationFile(ptr ptr ptr long long)
@ stdcall -stub ZwSetInformationJobObject(ptr long ptr long)
@ stdcall -stub ZwSetInformationObject(ptr long ptr long)
@ stdcall -stub ZwSetInformationProcess(ptr long ptr long)
@ stdcall -stub ZwSetInformationThread(ptr long ptr long)
@ stdcall -stub ZwSetSecurityObject(ptr long ptr)
@ stdcall -stub ZwSetSystemInformation(long ptr long)
@ stdcall -stub ZwSetSystemTime(ptr ptr)
@ stdcall -stub ZwSetTimer(ptr ptr ptr ptr long long ptr)
@ stdcall -stub ZwSetValueKey(ptr ptr long long ptr long)
@ stdcall -stub ZwSetVolumeInformationFile(ptr ptr ptr long long)
@ stdcall -stub ZwTerminateJobObject(ptr long)
@ stdcall -stub ZwTerminateProcess(ptr long)
@ stdcall -stub ZwTranslateFilePath(ptr long ptr long)
@ stdcall -stub ZwUnloadDriver(ptr)
@ stdcall -stub ZwUnloadKey(ptr)
@ stdcall -stub ZwUnmapViewOfSection(ptr ptr)
@ stdcall -stub ZwWaitForMultipleObjects(long ptr long long ptr)
@ stdcall -stub ZwWaitForSingleObject(ptr long ptr)
@ stdcall -stub ZwWriteFile(ptr ptr ptr ptr ptr ptr long ptr ptr)
@ stdcall -stub ZwYieldExecution()
