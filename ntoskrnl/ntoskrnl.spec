...
@ stdcall KsrEnumeratePersistedMemory(ptr ptr ptr)
@ stdcall KsrFreePersistedMemory(ptr)
@ stdcall KsrGetFirmwareInformation(ptr long)
@ stdcall KsrPersistMetadata(ptr ptr long)
@ stdcall KsrQueryMetadata(ptr ptr ptr)
...
@ stdcall -arch=x86_64 RtlClearAllBitsEx(ptr)
@ stdcall RtlClearBit(ptr long)
@ stdcall -arch=x86_64 RtlClearBitEx(ptr int64)
@ stdcall RtlClearBits(ptr long long)
@ stdcall -arch=x86_64 RtlClearBitsEx(ptr int64 int64)
...
@ stdcall -arch=x86_64 RtlFindSetBitsAndClearEx(ptr int64 int64)
@ stdcall -arch=x86_64 RtlFindSetBitsEx(ptr int64 int64)
...
@ stdcall -arch=x86_64 RtlInitializeBitMapEx(ptr ptr int64)
...
@ stdcall -arch=x86_64 RtlInterlockedClearBitRunEx(ptr int64 int64)
@ stdcall -arch=x86_64 RtlInterlockedSetBitRunEx(ptr int64 int64)
...
@ stdcall -arch=x86_64 RtlNumberOfSetBitsEx(ptr)
...
@ stdcall -arch=x86_64 RtlSetAllBitsEx(ptr)
@ stdcall RtlSetBit(ptr long)
@ stdcall -arch=x86_64 RtlSetBitEx(ptr int64)
@ stdcall RtlSetBits(ptr long long)
@ stdcall -arch=x86_64 RtlSetBitsEx(ptr int64 int64)
...
# =========================================================================
# NT 6.0+ kernel exports, backed by ntoskrnl_vista and the kernel itself.
# See sdk/lib/drivers/ntoskrnl_vista.
# =========================================================================
...
@ stdcall -version=0x602+ KeConvertAuxiliaryCounterToPerformanceCounter(int64 ptr ptr)
...
@ stdcall -version=0x600+ KeDeregisterProcessorChangeCallback(ptr)
